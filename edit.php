...
<td bgcolor="#FFFFFF" valign="top" width="200"><input type="checkbox" name="record" value="1" checked="checked"/>表示する
<input type="checkbox" name="record" value="0" />表示しない</font></td>
</tr>
